...
import (
	...
	"github.com/Presbyter/services/src/service/auth-service/handlers"
...
func NewEndpoints(service pb.AuthServer) svc.Endpoints {
	...
	var (
		...
		gettokenEndpoint     = svc.MakeGetTokenEndpoint(service)
		refreshtokenEndpoint = svc.MakeRefreshTokenEndpoint(service)
		bantokenEndpoint     = svc.MakeBanTokenEndpoint(service)
	)
