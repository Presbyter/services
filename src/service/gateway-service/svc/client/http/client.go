...
func New(instance string, options ...httptransport.ClientOption) (pb.UserServer, error) {
	...
	var UserInfoZeroEndpoint endpoint.Endpoint
	{
		UserInfoZeroEndpoint = httptransport.NewClient(
			"GET",
			copyURL(u, "/api/v1/user/"),
			EncodeHTTPUserInfoZeroRequest,
	...
	return svc.Endpoints{
		UserInfoEndpoint: UserInfoZeroEndpoint,
	}, nil
}
...
// DecodeHTTPUserInfoResponse is a transport/http.DecodeResponseFunc that decodes
// a JSON-encoded UserInfoResp response from the HTTP response body.
// If the response has a non-200 status code, we will interpret that as an
// error and attempt to decode the specific error message from the response
// body. Primarily useful in a client.
func DecodeHTTPUserInfoResponse(_ context.Context, r *http.Response) (interface{}, error) {
	defer r.Body.Close()
...
// EncodeHTTPUserInfoZeroRequest is a transport/http.EncodeRequestFunc
// that encodes a userinfo request into the various portions of
// the http request (path, query, and body).
func EncodeHTTPUserInfoZeroRequest(_ context.Context, r *http.Request, request interface{}) error {
	strval := ""
	_ = strval
