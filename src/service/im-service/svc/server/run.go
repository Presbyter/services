...
import (
	...
	"github.com/Presbyter/services/src/service/im-service/handlers"
...
func NewEndpoints(service pb.ImServer) svc.Endpoints {
	// Business domain.
	...
	var (
		...
		addgroupEndpoint      = svc.MakeAddGroupEndpoint(service)
		deletegroupEndpoint   = svc.MakeDeleteGroupEndpoint(service)
		addfriendEndpoint     = svc.MakeAddFriendEndpoint(service)
		deletefriendEndpoint  = svc.MakeDeleteFriendEndpoint(service)
	)
